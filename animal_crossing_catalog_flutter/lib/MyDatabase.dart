...
class MyDatabase extends _$MyDatabase {
  ...
  void updateData(String table, int index, bool selected) async {
    ...
    switch (table) {
      ...
      case 'acgc_song':
        {
          await update(acgcSong)
            ..where((tbl) => acgcSong.index.equals(index))
            ..write(AcgcSongData(selected: s));
          break;
        }
      case 'acgc_stationery':
        {
          await update(acgcStationery)
      ...
      case 'acww_song':
        {
          await update(acwwSong)
            ..where((tbl) => acwwSong.index.equals(index))
            ..write(AcwwSongData(selected: s));
          break;
        }
      case 'acww_stationery':
        {
          await update(acwwStationery)
      ...
      case 'accf_song':
        {
          await update(accfSong)
            ..where((tbl) => accfSong.index.equals(index))
            ..write(AccfSongData(selected: s));
          break;
        }
      case 'accf_stationery':
        {
          await update(accfStationery)
      ...
      case 'acnl_fossil':
        {
          await update(acnlFossil)
            ..where((tbl) => acnlFossil.index.equals(index))
            ..write(AcnlFossilData(selected: s));
          break;
        }
      case 'acnl_fossil_model':
        {
          await update(acnlFossilModel)
      ...
      case 'acnl_song':
        {
          await update(acnlSong)
            ..where((tbl) => acnlSong.index.equals(index))
            ..write(AcnlSongData(selected: s));
          break;
        }
      case 'acnl_stationery':
        {
          await update(acnlStationery)
      ...
      case 'acnl_tool':
        {
          await update(acnlTool)
            ..where((tbl) => acnlTool.index.equals(index))
            ..write(AcnlToolData(selected: s));
          break;
        }
      case 'acnl_villager_picture':
        {
          await update(acnlVillagerPicture)
      ...
      case 'acnh_misc':
        {
          await update(acnhMisc)
            ..where((tbl) => acnhMisc.index.equals(index))
            ..write(AcnhMiscData(selected: s));
          break;
        }
      case 'acnh_wall_mounted':
        {
          await update(acnhWallMounted)
